...
assets/js/
  ...
  ui/sound.js               synthesized techno music + response/tool tones
...
- **sound**: optional techno music with response, tool, retrieval and write tones, off by default until you toggle it.
